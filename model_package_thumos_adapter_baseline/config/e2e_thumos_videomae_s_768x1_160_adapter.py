_base_ = [
    "/root/OpenTAD/configs/_base_/datasets/thumos-14/e2e_train_trunc_test_sw_256x224x224.py",  # dataset config
    "/root/OpenTAD/configs/_base_/models/actionformer.py",  # model config
]
